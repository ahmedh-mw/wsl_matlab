...
# sudo rm -f ~/dump3.tar
# sudo mv dump3.tar ~/dump3.tar

time sudo podman container restore --import=dump3.tar --name $cp_container_test3


# time sudo podman container restore --import=dump3.tar --name container_test_export3d
...
sudo podman exec $cp_container_test3 matlab-bs -batch "new_system('b')"
sudo podman exec $cp_container_test3 matlab-bs -batch "x=14"
sudo podman exec $cp_container_test3 matlab-bs -batch "x"
